...
# Combined producers automatically unpack tuples in lambdas (works with `rpl::map`, `rpl::filter`, and `rpl::on_next`AGENTS.md
...
This project includes the **pavnxet/superpowers** template  
